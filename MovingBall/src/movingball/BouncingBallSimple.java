...
public class BouncingBallSimple extends JPanel {
    ...
    private float ballX2 = ballRadius + 50; // Ball's center (x, y)
    private float ballY2 = ballRadius + 20;
    private float ballSpeedX2 = 10;   // Ball's speed for x and y
    private float ballSpeedY2 = 11;
        ...
        Thread gameThread = new Thread() {
            public void run() {
               ...
               // Check if the ball moves over the bounds
                    ...
                    if (ballX2 - ballRadius < 0) {
                        ballSpeedX2 = -ballSpeedX2; // Reflect along normal
                        ballX2 = ballRadius; // Re-position the ball at the edge
                    } else if (ballX2 + ballRadius > BOX_WIDTH) {
                        ballSpeedX2 = -ballSpeedX2;
                        ballX2 = BOX_WIDTH - ballRadius;
                    }
                    // May cross both x and y bounds
                    if (ballY2 - ballRadius < 0) {
                        ballSpeedY2 = -ballSpeedY2;
                        ballY2 = ballRadius;
                    } else if (ballY2 + ballRadius > BOX_HEIGHT) {
                        ballSpeedY2 = -ballSpeedY2;
                        ballY2 = BOX_HEIGHT - ballRadius;
                    }
                    // Refresh the display
    ...
    public void paintComponent(Graphics g) {
        ...
        g.fillOval((int) (ballX2 - ballRadius), (int) (ballY2 - ballRadius),
                (int) (2 * ballRadius), (int) (2 * ballRadius));
        ...
        formatter.format("Ball2 @(%3.0f,%3.0f) Speed=(%2.0f,%2.0f)", ballX2, ballY2,
